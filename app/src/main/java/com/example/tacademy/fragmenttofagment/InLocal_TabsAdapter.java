...
public class InLocal_TabsAdapter extends FragmentPagerAdapter implements OnTabChangeListener, ViewPager.OnPageChangeListener {
	...
	public InLocal_TabsAdapter(FragmentActivity activity, TabHost tabHost,
							   ViewPager pager) {
		this(activity,activity.getSupportFragmentManager(),tabHost,pager);
	}
	
	public InLocal_TabsAdapter(Context context, FragmentManager fragmentManager, TabHost tabHost, ViewPager pager) {
